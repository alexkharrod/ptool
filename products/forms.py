...
class CreateProductForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["carton_qty"].required = False
        self.fields["carton_weight"].required = False
        self.fields["carton_width"].required = False
        self.fields["carton_length"].required = False
        self.fields["carton_height"].required = False
        self.fields["air_freight"].required = False
        self.fields["ocean_freight"].required = False
